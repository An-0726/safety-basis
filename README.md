...
- `knowledge/`：96个法规身份、97个版本、2,843条条款、1,608项隐患（含现行、历史、合并和待审核状态）、1,782个关联。
- `source/publication/`：216项公开目录；15份获准公开全文；140项官方入口。
- `source/releases/current/`：1,520项公开隐患（1,509项已核验 + 11项待审核候选）、222项法规版本、1,303条正式发布条款、1,757个正式关联；候选记录可查但不能直接作为正式依据。
...
- 1264条Excel新增隐患中，1,250条已正式核验，3条已合并到已有正式隐患，11条仍待外部资料或实施状态确认，见 `docs/EXCEL_PENDING_VERIFICATION_20260913.md`。
