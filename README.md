...
2026-09-19 当前维护分支正式发布基线：

- **1,502 条正式隐患**；
- **58 个实际引用法规版本**；
- **1,276 条正式条款**；
- **1,621 个正式关联**；
- **426 条 proposed 候选留在 knowledge，正式公开 0 条候选**；
- publication 目录为 **69 个 canonical 来源关系（11 full_text + 58 link_only）**。

本轮纠错专项（PR #60 / PR #61 定点纠偏）彻底消除了此前遗留的 blockers 与模型偏差：纠正危化法第五条正式原文、撤销 GB 12158 5 条 proposed 候选的不当标题合并（421→426）、高精度修复 9 条 active clause 科学计数法指数排版、逐条严格重构缩窄 PR #61 转正的 8 条危废贮存隐患（清除旧版附录A、非官方“专用设施”、越权“防火/防雷/消防/通讯”及宽泛选址，严格补齐触发条件与适用边界），将 GB 18597-2023 归并归属至规范版本卡 `L023`，并客观记录私有母库历史写入后恢复备份的事实；全库质量扫描器实测真实错误清零；旧的 1,409、1,429、1,442、1,458、1,484、1,494、1,495 等数量仅是更早阶段历史基线，不得再作为当前正式站口径。
...
- knowledge：103 个法规身份、106 个法规版本、2,920 条条款、2,015 个隐患实体（1,494 active / 429 proposed / 92 superseded）、1,634 个关联；
- 新版 Excel 目标集：1,929 个唯一隐患 ID（621 条修订、1,308 条保留）；
- 当前正式发布：1,494 / 58 / 1,266 / 1,610（隐患 / 实际引用法规版本 / 条款 / 关联）；
- 当前 proposed：429，仅后台；
