...
2026-09-18 当前维护分支正式发布基线：

- **1,494 条正式隐患**；
- **58 个实际引用法规版本**；
- **1,266 条正式条款**；
- **1,610 个正式关联**；
- **429 条 proposed 候选留在 knowledge，正式公开 0 条候选**；
- publication 目录为 **69 个 canonical 来源关系（11 full_text + 58 link_only）**。

本轮 PHASE 13 完成全库 434 条 proposed 候选逐条机器最终处置（434/434），闭环合并 6 条重复隐患（1 组 active 重名与 5 条 proposed 重名），修复 14 个 rejected link 状态不一致，全库质量扫描器真实错误清零；旧的 1,409、1,429、1,442、1,458、1,484、1,495 等数量仅是更早阶段历史基线，不得再作为当前正式站口径。
