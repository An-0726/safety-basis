...
- **1,276 条正式条款**；
- **1,621 个正式关联**；
- **421 条 proposed 候选留在 knowledge，正式公开 0 条候选**；
- publication 目录为 **69 个 canonical 来源关系（11 full_text + 58 link_only）**。

本轮 PHASE 14 完成强制性国家标准《危险废物贮存污染控制标准》（GB 18597-2023）专项收录与 8 条危废贮存核心隐患转正（11 个 direct links），其余 10 条危废候选继续审慎保留 proposed（详见 `docs/phase14-gb18597-disposition.jsonl`），全库质量扫描器真实错误清零；旧的 1,409、1,429、1,442、1,458、1,484、1,494、1,495 等数量仅是更早阶段历史基线，不得再作为当前正式站口径。
