...
2026-09-17 当前 `main` 正式发布基线：

- **1,429 条正式隐患**；
- **57 个实际引用法规版本**；
- **1,205 条正式条款**；
- **1,544 个正式关联**；
- **499 条 proposed 候选留在 knowledge，正式公开 0 条候选**；
- publication 目录为 **69 个 canonical 来源关系（11 full_text + 58 link_only）**。

该正式发布首先由 PR #40 进入 `main`，PR #41 为纯状态收尾；后者不改变 governed knowledge/publication 业务数据。旧的 1,409 / 55 / 1,193 / 1,524 / 519 仅是更早阶段历史基线，不得再作为当前正式站口径。
...
- knowledge：103 个法规身份、106 个法规版本、2,847 条条款、2,014 个隐患实体、1,567 个关联；
- 新版 Excel 目标集：1,929 个唯一隐患 ID（621 条修订、1,308 条保留）；
- 当前正式发布：1,429 / 57 / 1,205 / 1,544（隐患 / 实际引用法规版本 / 条款 / 关联）；
- 当前 proposed：499，仅后台；
