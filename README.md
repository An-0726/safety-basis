...
- **1,258 条正式条款**；
- **1,600 个正式关联**；
- **445 条 proposed 候选留在 knowledge，正式公开 0 条候选**；
- publication 目录为 **69 个 canonical 来源关系（11 full_text + 58 link_only）**。

本轮两个 GB/T 47236-2026 专题批次共将 42 条直接匹配候选转正；旧的 1,409、1,429、1,442、1,458 等数量仅是更早阶段历史基线，不得再作为当前正式站口径。
...
- knowledge：103 个法规身份、106 个法规版本、2,920 条条款、2,015 个隐患实体、1,623 个关联；
- 新版 Excel 目标集：1,929 个唯一隐患 ID（621 条修订、1,308 条保留）；
- 当前正式发布：1,484 / 58 / 1,258 / 1,600（隐患 / 实际引用法规版本 / 条款 / 关联）；
- 当前 proposed：445，仅后台；
