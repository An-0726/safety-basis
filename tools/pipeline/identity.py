...
def main():
    ...
    result=propose(args.db,args.source,args.target,args.evidence,args.reason,args.output) if args.command=='propose' else apply(args.db,args.proposal,args.actor)
