...
## Review totals: {"verified": 721, "rejected": 20}
review_total=741, verified_without_evidence=520

## Shared chained gate
- eligibleHazards=645, eligibleLinks=721, strictBlockers=0
...
## RELEASE 核对明细
- strict gate PASS: eligibleHazards=645 eligibleLinks=721
